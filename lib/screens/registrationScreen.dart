                    ...
                    RaisedButton(
                      ...
                      onPressed: (){
                        if(nameTextEditingController.text.length <3){
                          ...
                          displayTextMessage("E-mail address is not valid!", context);
                        } else if(phoneTextEditingController.text.isEmpty){
                          displayTextMessage("Phone number is necessary", context);
                        } else if(passwordTextEditingController.text.length<6){
                          displayTextMessage("Password must be at least 6 characters", context);
                        } else if(confirmPasswordTextEditingController.text.length<6 && confirmPasswordTextEditingController != passwordTextEditingController){
